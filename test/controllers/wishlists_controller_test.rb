...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { desc: @wishlist.desc, link: @wishlist.link, nome: @wishlist.nome, user_id: @wishlist.user_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { desc: @wishlist.desc, link: @wishlist.link, nome: @wishlist.nome, user_id: @wishlist.user_id } }
